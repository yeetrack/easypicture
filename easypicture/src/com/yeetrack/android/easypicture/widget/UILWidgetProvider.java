 ...
 *******************************************************************************/
package com.yeetrack.android.easypicture.widget;
...
import com.yeetrack.android.easypicture.UILApplication;
...
public class UILWidgetProvider extends AppWidgetProvider {
	...
	static void updateAppWidget(Context context, final AppWidgetManager appWidgetManager, final int appWidgetId) {
		...
		ImageLoader.getInstance()
				.loadImage(Constant.IMAGES[0], minImageSize, displayOptions, new SimpleImageLoadingListener() {
					@Override
		...
		ImageLoader.getInstance()
				.loadImage(Constant.IMAGES[1], minImageSize, displayOptions, new SimpleImageLoadingListener() {
					@Override
					public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
